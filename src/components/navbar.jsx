...
export default function Navbar() {
  ...
  return (
    <div className="relative w-full h-16">
      ...
      <div
        className={`lg:hidden absolute top-16 left-0 z-50 w-full bg-black/30 rounded-2xl backdrop-blur-md overflow-hidden transition-[max-height] duration-300 ease-in-out ${
